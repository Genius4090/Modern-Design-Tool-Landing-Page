...
export default function Hero() {
    ...
    <section className="py-24 overflow-x-clip" style={{
     ...
     <div className="container relative">
         ...
         <p className="text-center text-xl text-white/50 mt-8 max-w-2xl mx-auto">Design tools shouldn&apos;t slow you down. Layers combiners powerful features with an intuitive interface that keeps you in your creative flow.</p>

         <form className="flex border border-white/15 rounded-full p-2 mt-8 max-w-lg mx-auto">
             <input type="email" placeholder="Enter your email" className="bg-transparent px-4 w-full md:flex-1 outline-none"/>
