...
export default function Integrations() {
    return (
        ...
        <div className="container">
            ...
            <p className="text-white/50 mt-4 text-lg">Layers seamlessly connects with your favorite tools, making it e asy to plug into any workflow and collaborate across platforms.</p>
                </div>
                <div>
